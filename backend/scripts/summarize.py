...
def build_prompt(summary, examples):
    ...
    prompt = f"""You are an expert in stylometry. Based on the following summary and examples, create a concise style guide for mimicking this writer's **structural and syntactic style only**. Do not include any domain-specific vocabulary, names, or topics.
...
- Tone & Voice
- Sentence Structure
- Vocabulary & Phrasing (focus on function words, general phrasing, and common connectors; do not mention domain terms)
- Punctuation & Formatting
- Transitions & Discourse Markers

Use bullet points. Be specific and actionable. Do not include any anti-AI writing instructions.
"""
    return prompt
